...
import os,xlwt,requests,json,threading,tqdm,datetime,time,ip2Region
...
if __name__ == '__main__':
    ...
    start = time.time()
    # print("开始进行子域名收集")
    # cmd = "echo hackerone.com | subfinder  -silent -t 20| httpx -silent -status-code -title -ip -nc -cdn -fc 403,404,400"
    # print("执行的命令为："+cmd)
    # p = os.popen(cmd)
    # x = p.read()
